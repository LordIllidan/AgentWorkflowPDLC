...
| `.github/scripts/pdlc-claude-diagnostics.ps1` | Shared CI console annotations, `--debug-file`, session JSONL copies under `pdlc-runs/`, optional diagnostic commit on failure. See `docs/pdlc-claude-diagnostics.md`. |
